...
import { ReadonlyDeep, Merge, FilterArrayByKey, FilterArrayByValue, SetPropsOptionalIfChildrenAreOptional, PickDefined, UndefinedToOptional, MapSchemaParameters, PathParamNames, NeverIfEmpty, Simplify, RequiredKeys, UndefinedIfNever, IfEquals } from './utils.types.mjs';
...
type ZodiosResponseForEndpoint<Endpoint extends ZodiosEndpointDefinition, Frontend extends boolean = true> = Frontend extends true ? z4__default.output<Endpoint["response"]> : z4__default.input<Endpoint["response"]>;
type ZodiosResponseByPath<Api extends ZodiosEndpointDefinition[], M extends Method, Path extends ZodiosPathsByMethod<Api, M>, Frontend extends boolean = true> = Frontend extends true ? z4__default.output<ZodiosEndpointDefinitionByPath<Api, M, Path>[number]["response"]> : z4__default.input<ZodiosEndpointDefinitionByPath<Api, M, Path>[number]["response"]>;
type ZodiosResponseByAlias<Api extends ZodiosEndpointDefinition[], Alias extends string, Frontend extends boolean = true> = Frontend extends true ? z4__default.output<ZodiosEndpointDefinitionByAlias<Api, Alias>[number]["response"]> : z4__default.input<ZodiosEndpointDefinitionByAlias<Api, Alias>[number]["response"]>;
...
type ZodiosErrorForEndpoint<Endpoint extends ZodiosEndpointDefinition, Status extends number, Frontend extends boolean = true> = Frontend extends true ? z4__default.output<IfNever<FilterArrayByValue<Endpoint["errors"], {
    status: Status;
}>[number]["schema"], ZodiosDefaultErrorForEndpoint<Endpoint>>> : z4__default.input<IfNever<FilterArrayByValue<Endpoint["errors"], {
    status: Status;
}>[number]["schema"], ZodiosDefaultErrorForEndpoint<Endpoint>>>;
type ZodiosErrorByPath<Api extends ZodiosEndpointDefinition[], M extends Method, Path extends ZodiosPathsByMethod<Api, M>, Status extends number, Frontend extends boolean = true> = Frontend extends true ? z4__default.output<IfNever<FilterArrayByValue<ZodiosEndpointDefinitionByPath<Api, M, Path>[number]["errors"], {
    status: Status;
}>[number]["schema"], ZodiosDefaultErrorByPath<Api, M, Path>>> : z4__default.input<IfNever<FilterArrayByValue<ZodiosEndpointDefinitionByPath<Api, M, Path>[number]["errors"], {
    status: Status;
...
type ErrorsToAxios<T, Acc extends unknown[] = []> = T extends [
    ...
    status: infer Status;
    schema: infer Schema;
} ? Schema extends z4__default.core.$ZodType ? ErrorsToAxios<Tail, [
    ...Acc,
    Merge<Omit<AxiosError, "status" | "response">, {
        response: Merge<AxiosError<z4__default.output<Schema>>["response"], {
...
type ZodiosErrorByAlias<Api extends ZodiosEndpointDefinition[], Alias extends string, Status extends number, Frontend extends boolean = true> = Frontend extends true ? z4__default.output<IfNever<FilterArrayByValue<ZodiosEndpointDefinitionByAlias<Api, Alias>[number]["errors"], {
    status: Status;
}>[number]["schema"], ZodiosDefaultErrorByAlias<Api, Alias>>> : z4__default.input<IfNever<FilterArrayByValue<ZodiosEndpointDefinitionByAlias<Api, Alias>[number]["errors"], {
    status: Status;
...
type ZodiosBodyForEndpoint<Endpoint extends ZodiosEndpointDefinition, Frontend extends boolean = true> = Frontend extends true ? z4__default.input<BodySchemaForEndpoint<Endpoint>> : z4__default.output<BodySchemaForEndpoint<Endpoint>>;
type ZodiosBodyByPath<Api extends ZodiosEndpointDefinition[], M extends Method, Path extends ZodiosPathsByMethod<Api, M>, Frontend extends boolean = true> = Frontend extends true ? z4__default.input<BodySchema<Api, M, Path>> : z4__default.output<BodySchema<Api, M, Path>>;
...
type ZodiosBodyByAlias<Api extends ZodiosEndpointDefinition[], Alias extends string, Frontend extends boolean = true> = Frontend extends true ? z4__default.input<BodySchemaByAlias<Api, Alias>> : z4__default.output<BodySchemaByAlias<Api, Alias>>;
...
type ZodiosEndpointParameter<S = unknown> = {
    /**
     ...
     */
    schema: z4__default.core.$ZodType<S>;
};
type ZodiosEndpointParameters = ZodiosEndpointParameter[];
type ZodiosEndpointError<S = unknown> = {
    /**
...
interface ZodiosEndpointDefinition<R = unknown> {
     ...
     */
    response: z4__default.core.$ZodType;
    /**
...
type ZodiosEndpointDefinitions<T extends z4__default.core.$ZodType = z4__default.core.$ZodType> = ZodiosEndpointDefinition<T>[];
/**
...
export type { Aliases, AnyZodiosMethodOptions, AnyZodiosRequestOptions, BodySchema, BodySchemaByAlias, BodySchemaForEndpoint, ErrorsToAxios, Method, MutationMethod, RequestFormat, ZodiosAliasRequest, ZodiosAliases, ZodiosBodyByAlias, ZodiosBodyByPath, ZodiosBodyForEndpoint, ZodiosDefaultErrorForEndpoint, ZodiosEndpointDefinition, ZodiosEndpointDefinitionByAlias, ZodiosEndpointDefinitionByPath, ZodiosEndpointDefinitions, ZodiosEndpointError, ZodiosEndpointErrors, ZodiosEndpointParameter, ZodiosEndpointParameters, ZodiosErrorByAlias, ZodiosErrorByPath, ZodiosErrorForEndpoint, ZodiosHeaderParamsByAlias, ZodiosHeaderParamsByPath, ZodiosHeaderParamsForEndpoint, ZodiosMatchingErrorsByAlias, ZodiosMatchingErrorsByPath, ZodiosMethodOptions, ZodiosMutationAliasRequest, ZodiosOptions, ZodiosPathParamByAlias, ZodiosPathParams, ZodiosPathParamsByPath, ZodiosPathParamsForEndpoint, ZodiosPathsByMethod, ZodiosPlugin, ZodiosQueryParamsByAlias, ZodiosQueryParamsByPath, ZodiosQueryParamsForEndpoint, ZodiosRequestOptions, ZodiosRequestOptionsByAlias, ZodiosRequestOptionsByPath, ZodiosResponseByAlias, ZodiosResponseByPath, ZodiosResponseForEndpoint };
