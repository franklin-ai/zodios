...
type Narrow<T> = T extends z4.core.$ZodType ? T : T extends (infer U)[] ? Narrow<U>[] : T extends Record<string | number | symbol, any> ? {
...
type MapSchemaParameters<T, Frontend extends boolean = true, Acc = {}> = T extends [infer Head, ...infer Tail] ? Head extends {
    ...
    [Key in Name]: Schema extends z4.ZodType ? Frontend extends true ? z4.input<Schema> : z4.output<Schema> : never;
}, Acc>> : Acc : Acc : Acc;
/**
...
export type { ApiPathToParams, Assert, DeepReadonlyObject, DefinedArray, FilterArrayByKey, FilterArrayByValue, IfEquals, MapSchemaParameters, MaybeReadonly, Merge, MergeUnion, Narrow, NeverIfEmpty, OptionalChildProps, OptionalProps, PathParamNames, PickDefined, PickRequired, ReadonlyDeep, RequiredKeys, RequiredProps, SetPropsOptionalIfChildrenAreOptional, Simplify, Split, SplitMany, TupleFlat, UndefinedIfEmpty, UndefinedIfNever, UndefinedToOptional, UnionToIntersection, UnionToTuple };
